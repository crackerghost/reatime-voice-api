...
export default function BottomBar({
  ...
  useEffect(() => {
    ...
    // Soft aurora wash: huge radii, flat core, slowest drift — no ball glows.
    const blobs = [
      { c: [59, 70, 255], x: 0.22, y: 1.05, r: 1.0, s: 0.035, p: 0.0 }, // deep blue
      { c: [124, 93, 250], x: 0.42, y: 1.12, r: 0.95, s: 0.04, p: 2.1 }, // violet
      { c: [255, 179, 122], x: 0.58, y: 1.08, r: 0.9, s: 0.035, p: 4.2 }, // warm peach
      { c: [92, 255, 157], x: 0.78, y: 1.02, r: 0.88, s: 0.035, p: 1.2 }, // mint
      { c: [255, 90, 95], x: 0.5, y: 1.2, r: 0.95, s: 0.03, p: 3.0 }, // brand red undertow
    ];
